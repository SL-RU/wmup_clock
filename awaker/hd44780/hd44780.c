...
#define HD44780_TIMER 		TIM3
#define HD44780_CLK_EN		__TIM3_CLK_ENABLE
#define HD44780_PRIORITY 	1
#define HD44780_IRQ 		TIM3_IRQn
#define HD44780_HANDLER		TIM3_IRQHandler

//#define BKL_GPIO_EN			__GPIOA_CLK_ENABLE
//#define BKL_GPIO			GPIOA
...
void hd44780_brightness(const uint8_t brightness) {
	...
	HAL_GPIO_WritePin(GPIOA, GPIO_PIN_7, brightness ? GPIO_PIN_SET : GPIO_PIN_RESET);
}
